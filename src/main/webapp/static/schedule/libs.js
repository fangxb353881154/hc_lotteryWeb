 ...
 * Email: xuyu2@staff.sina.com.cn
 */
udvDefine('globalConfig', [], function () {
    return {
        AppKey: 3571367214
    }
});
 ...
 */
udvDefine('util', ['require', '$'], function (require) {
    require('$');
    var expose = {};
...
udvDefine('text', ["module"], function (module) {
    ...
    text = {
        version: "2.0.6", strip: function (content) {
            if (content) {
            ...
            if (buildMap.hasOwnProperty(moduleName)) {
                ...
                write.asModule(pluginName + "!" + moduleName, "udvDefine(function () { return '" + content + "';});\n")
            }
 ...
 * Email: xuyu2@staff.sina.com.cn
 */
udvDefine('templateHelper', [], function () {
